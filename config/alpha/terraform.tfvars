...
s3_bucket_adjust_logs           = "adjust-logs-2c74753f"
...
### sfmc-data
sfmc_bucket = "bb2-alpha-datalake-curated" # TODO: non-consistent data, need to check

#currency cloud variable
slscurrencycloud_auth_details         = "data/currencycloud/api" # TODO: rewrite this with parameters etc.

### cards-paymentology
s3_sftp_paymentology_bucket           = "sftp-replica-a431a3de"
